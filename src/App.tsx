    ...
    <main className="grain overflow-hidden">
      <header className="absolute left-0 right-0 top-0 z-40 text-[#24302b]">
        <div className="mx-auto flex max-w-[1440px] items-center justify-between px-5 py-5 md:px-10 md:py-7">
          ...
          <nav className="hidden items-center gap-8 lg:flex" aria-label="Основная навигация">
            {navItems.map((item) => (
                <a key={item.href} href={item.href} className="text-[11px] uppercase tracking-[.13em] text-[#24302b]/70 transition-colors hover:text-[#6c8173]" data-testid={`link-nav-${item.label.toLowerCase().replaceAll(' ', '-')}`}>
                {item.label}
              </a>
            ))}
          </nav>
        ...
        {menuOpen && (
          <div className="absolute left-0 right-0 top-[73px] border-y border-[#24302b]/15 bg-[#dce9df] px-5 py-6 lg:hidden">
            <nav className="flex flex-col gap-5" aria-label="Мобильная навигация">
              ...
              <button type="button" onClick={() => { setMenuOpen(false); scrollToContact(); }} className="w-fit border-b border-[#6c8173] pb-1 text-[12px] uppercase tracking-[.16em] text-[#6c8173]" data-testid="button-mobile-inquire">
                Обсудить событие
              </button>
            </nav>
          </div>
      ...
      <section id="top" className="relative flex min-h-[720px] items-end bg-[#f4f0e8] text-[#24302b] md:min-h-[850px]">
        ...
        <div className="relative z-10 mx-auto w-full max-w-[1440px] px-5 pb-16 pt-36 md:px-10 md:pb-24">
          <div className="max-w-[960px]">
            <p className="eyebrow mb-8 text-[#6c8173] reveal" data-testid="text-hero-eyebrow">Студия декора событий · Москва / по всей России</p>
            ...
            <div className="mt-10 flex max-w-[590px] flex-col gap-8 sm:flex-row sm:items-end sm:justify-between reveal reveal-delay-2">
               ...
               <a href="#projects" className="group flex w-fit items-center gap-3 text-[11px] uppercase tracking-[.14em] text-[#6c8173]" data-testid="link-hero-projects">
                Смотреть проекты <ArrowDownRight size={17} strokeWidth={1.2} className="transition-transform group-hover:translate-x-1 group-hover:translate-y-1" />
              </a>
            </div>
          </div>
          <div className="mt-20 flex justify-end border-t border-[#24302b]/20 pt-4 md:mt-28">
            <a href="#approach" className="group flex items-center gap-3 text-[11px] uppercase tracking-[.14em] text-[#6c8173]" data-testid="link-hero-approach">
              К подходу <ArrowDownRight size={17} strokeWidth={1.2} className="transition-transform group-hover:translate-x-1 group-hover:translate-y-1" />
            </a>
          </div>
        </div>
      </section>
      ...
      <section id="approach" className="bg-[#f4f0e8] px-5 py-24 md:px-10 md:py-36">
        <div className="mx-auto grid max-w-[1440px] gap-14 md:grid-cols-[.88fr_1.12fr] md:gap-24">
          ...
          <div className="grid items-end gap-10 md:grid-cols-[.8fr_1.2fr] md:gap-16" data-reveal>
            ...
            <div className="border-l border-[#24302b]/20 pl-6">
              <p className="text-[clamp(3.3rem,6vw,5.5rem)] leading-none tracking-[-.07em] text-[#6c8173] serif" data-testid="text-stat-events">86</p>
        ...
        <div className="mx-auto mt-24 max-w-[1440px] border-t border-[#24302b]/20 pt-5" data-reveal>
          <div className="grid gap-9 sm:grid-cols-3">
            <div><p className="eyebrow text-[#6c8173]">Материал</p><p className="mt-3 text-[15px] text-[#24302b]/75">Ткань, которая мнётся красиво. Ветка, которая живёт своей линией.</p></div>
            <div><p className="eyebrow text-[#6c8173]">Ритм</p><p className="mt-3 text-[15px] text-[#24302b]/75">Пустота между объектами важна так же, как сам объект.</p></div>
            <div><p className="eyebrow text-[#6c8173]">Память</p><p className="mt-3 text-[15px] text-[#24302b]/75">После нас остаются фотографии. Но главное — то, что на них не попало.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#f4f0e8] px-5 py-20 md:px-10 md:py-28">
        <div className="mx-auto grid max-w-[1440px] items-center gap-12 md:grid-cols-[1.05fr_.95fr] md:gap-24">
          <div className="relative overflow-hidden" data-reveal>
            <img src={tableImage} alt="Деталь сервировки с цветами и свечами" className="aspect-[4/3] w-full object-cover transition-transform duration-700 hover:scale-[1.03]" data-testid="img-approach-detail" />
          ...
          <div data-reveal>
            <p className="eyebrow mb-7 text-[#6c8173]">Что мы делаем</p>
            ...
            <a href="#contact" className="group mt-10 flex w-fit items-center gap-3 border-b border-[#24302b]/35 pb-2 text-[11px] uppercase tracking-[.14em] text-[#24302b]" data-testid="link-approach-contact">
              Рассказать о своём событии <ArrowUpRight size={17} strokeWidth={1.2} className="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-[1440px]">
          ...
          <div id="grid-projects" className="grid auto-rows-[260px] grid-flow-dense grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-12 lg:auto-rows-[190px]" data-testid="grid-projects">
            {visibleProjects.map((project, index) => (
              <article
                key={project.title}
                className={`group relative cursor-pointer overflow-hidden bg-[#24302b] outline-none transition-transform duration-500 hover:-translate-y-1 focus-visible:ring-2 focus-visible:ring-[#6c8173] focus-visible:ring-offset-4 focus-visible:ring-offset-[#f4f0e8] ${projectLayout(index, visibleProjects.length)}`}
                role="button"
                tabIndex={0}
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 flex items-end justify-between p-5 text-[#f4f0e8]">
                  ...
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#f4f0e8]/40 transition-colors group-hover:border-[#d8d4c9] group-hover:text-[#d8d4c9]"><ArrowUpRight size={16} strokeWidth={1.2} /></span>
                </div>
                <span className="absolute left-5 top-5 text-[10px] uppercase tracking-[.14em] text-[#f4f0e8]/0 transition-colors group-hover:text-[#f4f0e8]/75">Открыть проект</span>
              </article>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-[1440px]">
          <div className="grid gap-10 md:grid-cols-[.7fr_1.3fr] md:gap-24" data-reveal>
            ...
            <div className="self-end">
              ...
              <a href="#contact" className="group mt-8 flex w-fit items-center gap-3 border-b border-[#24302b]/35 pb-2 text-[11px] uppercase tracking-[.14em] text-[#24302b]" data-testid="link-process-contact">
                Обсудить ваше событие <ArrowUpRight size={17} strokeWidth={1.2} className="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
              </a>
            </div>
          </div>
        ...
        <div className="mx-auto grid max-w-[1440px] items-center gap-12 md:grid-cols-[.82fr_1.18fr] md:gap-28">
          ...
          <div data-reveal>
            ...
            <div className="mt-12 flex flex-col gap-8 border-t border-[#24302b]/20 pt-5 sm:flex-row sm:items-end sm:justify-between">
              <div>
                <p className="text-[clamp(3rem,5vw,5rem)] leading-none tracking-[-.07em] text-[#6c8173] serif">86</p>
                <p className="mt-2 text-[11px] uppercase leading-[1.5] tracking-[.12em] text-[#24302b]/60">событий собрано<br />за 8 лет</p>
              </div>
              <a href="#contact" className="group flex w-fit items-center gap-3 border-b border-[#24302b]/35 pb-2 text-[11px] uppercase tracking-[.14em] text-[#24302b]" data-testid="link-about-contact">
                Познакомиться с проектом <ArrowUpRight size={17} strokeWidth={1.2} className="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
              </a>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#f4f0e8] px-5 py-24 text-[#24302b] md:px-10 md:py-32">
        <div className="mx-auto grid max-w-[1440px] gap-10 md:grid-cols-[.45fr_1.55fr] md:gap-24" data-reveal>
          ...
          <blockquote>
            <p className="max-w-[940px] text-[clamp(2.65rem,5.7vw,6.4rem)] leading-[.92] tracking-[-.065em] serif">«Самые красивые события — те, где никто не старается выглядеть красиво».</p>
            <footer className="mt-10 flex items-center gap-3 text-[11px] uppercase tracking-[.13em] text-[#24302b]/65"><span className="h-px w-8 bg-[#24302b]/40" /> Елена Медведева, основатель студии</footer>
          </blockquote>
        </div>
      </section>

      <section id="contact" className="bg-[#f4f0e8] px-5 py-24 md:px-10 md:py-36">
        <div className="mx-auto grid max-w-[1440px] gap-16 md:grid-cols-[.8fr_1.2fr] md:gap-28">
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-8" data-reveal data-testid="form-contact">
              ...
              <div className="grid gap-8 sm:grid-cols-2">
                <label className="block"><span className="eyebrow mb-3 block text-[#24302b]/55">Формат события</span><select required name="type" defaultValue="" className="w-full border-0 border-b border-[#24302b]/25 bg-[#f4f0e8] px-0 py-3 text-[16px] text-[#24302b] outline-none focus:border-[#6c8173]" data-testid="select-event-type"><option value="" disabled>Выберите формат</option><option>Свадьба</option><option>Корпоративное событие</option><option>Детский праздник</option><option>Другое</option></select></label>
              ...
              <button type="submit" className="group flex items-center gap-3 bg-[#24302b] px-6 py-4 text-[11px] uppercase tracking-[.14em] text-[#f4f0e8] transition-colors hover:bg-[#6c8173]" data-testid="button-submit-contact">Запросить дату <ArrowUpRight size={17} strokeWidth={1.2} className="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" /></button>
          ...
          >
            ...
            <div className="flex flex-col justify-between p-7 md:p-12">
              ...
              <div className="mt-12 border-t border-[#24302b]/20 pt-5">
                ...
                <button type="button" onClick={() => { setSelectedProject(null); scrollToContact(); }} className="group mt-10 flex w-fit items-center gap-3 border-b border-[#24302b]/35 pb-2 text-[11px] uppercase tracking-[.14em]">
                  Обсудить похожее событие <ArrowUpRight size={17} strokeWidth={1.2} className="transition-transform group-hover:translate-x-1 group-hover:-translate-y-1" />
                </button>
              </div>
            </div>
          </div>
